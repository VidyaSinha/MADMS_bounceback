...
function AcademicPerformancePage(): JSX.Element {
    ...
    <div className="bg-white rounded-xl shadow p-6 max-w-5xl mx-auto">
      ...
      <table className="min-w-full text-sm text-left">
        <thead className="text-gray-500 border-b">
          <tr>
            <th className="py-3 px-4 font-semibold">Enrollment Number</th>
            <th className="py-3 px-4 font-semibold">Academic Year</th>
            <th className="py-3 px-4 font-semibold">Mean CGPA</th>
            <th className="py-3 px-4 font-semibold">Students Appeared</th>
          </tr>
        </thead>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
            ...
            <div className="space-y-2">
              <Label htmlFor="meanCgpa">Mean CGPA</Label>
              <Input
                id="meanCgpa"
                type="number"
                step="0.01"
